//! A bitlflags crate, mainly inspired by [enumflags2](https://crates.io/crates/enumflags2)
...
pub fn bitflags(_attr: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        ...
        impl #struct_name
        {
            ...
            #[must_use]
            #[inline(always)]
            pub const fn const_not(self) -> Self { #struct_name { _bits_do_not_use_it: !self.bits() & Self::ALL.bits() } } // Each 1 bit correspond to a variant that can be used, no illegal 1 bit
