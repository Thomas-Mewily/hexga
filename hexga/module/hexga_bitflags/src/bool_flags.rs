...
pub trait BoolFlagsIntegerUnsigned : NumberIntegerUnsigned + fmt::Binary {}
impl<T> BoolFlagsIntegerUnsigned for T where T: NumberIntegerUnsigned + fmt::Binary {}

#[cfg_attr(feature = "hexga_io", derive(Save, Load))]
#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy
{
    flags : U,
    phantom : PhantomData<F>,
}
impl<F,U> Default for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy
{
...
#[cfg(feature = "serde")]
impl<F,U> Serialize for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F> + Serialize, F : MaxValue + Copy {
...
#[cfg(feature = "serde")]
impl<'de,F,U> Deserialize<'de> for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F> + Deserialize<'de>, F : MaxValue + Copy
{
...
where
    U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy,
...
impl<F,U> From<F> for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy
{
    fn from(value: F) -> Self { Self::from_flag(value) }
}
impl<F,U> Zero for BoolFlags<F,U>  where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy
{
    const ZERO : Self = unsafe { Self::from_flags_unchecked(U::ZERO) };
}
impl<F,U> BoolFlags<F,U>  where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy
{
...
impl<F,U> IntoIterator for BoolFlags<F,U>
    where
    U : BoolFlagsIntegerUnsigned + From<F>,
    F : MaxValue + Copy + TryFrom<U>,
    <F as TryFrom<U>>::Error : Debug,
    RangeInclusive<U>: Iterator<Item = U>,
{
...
impl<F,U> BitAnd<Self> for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy { type Output=Self; fn bitand(self, rhs: Self) -> Self::Output { Self::from_flags(self.flags.bitand(rhs.flags)) } }
impl<F,U> BitAndAssign<Self> for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy { fn bitand_assign(&mut self, rhs: Self) { self.flags.bitand_assign(rhs.flags); } }
impl<F,U> BitAnd<F> for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy { type Output=Self; fn bitand(self, rhs: F) -> Self::Output { self.bitand(Self::from(rhs)) } }
impl<F,U> BitAndAssign<F> for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy { fn bitand_assign(&mut self, rhs: F) { self.bitand_assign(Self::from(rhs)); } }

impl<F,U> BitOr<Self> for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy { type Output=Self; fn bitor(self, rhs: Self) -> Self::Output { Self::from_flags(self.flags.bitor(rhs.flags)) } }
impl<F,U> BitOrAssign<Self> for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy { fn bitor_assign(&mut self, rhs: Self) { self.flags.bitor_assign(rhs.flags); } }
impl<F,U> BitOr<F> for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy { type Output=Self; fn bitor(self, rhs: F) -> Self::Output { self.bitor(Self::from(rhs)) } }
impl<F,U> BitOrAssign<F> for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy { fn bitor_assign(&mut self, rhs: F) { self.bitor_assign(Self::from(rhs)); } }

impl<F,U> BitXor<Self> for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy { type Output=Self; fn bitxor(self, rhs: Self) -> Self::Output { Self::from_flags(self.flags.bitxor(rhs.flags)) } }
impl<F,U> BitXorAssign<Self> for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy { fn bitxor_assign(&mut self, rhs: Self) { self.flags.bitxor_assign(rhs.flags); } }
impl<F,U> BitXor<F> for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy { type Output=Self; fn bitxor(self, rhs: F) -> Self::Output { self.bitxor(Self::from(rhs)) } }
impl<F,U> BitXorAssign<F> for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy { fn bitxor_assign(&mut self, rhs: F) { self.bitxor_assign(Self::from(rhs)); } }

impl<F,U> Not for BoolFlags<F,U> where U : BoolFlagsIntegerUnsigned + From<F>, F : MaxValue + Copy
{
    type Output=Self;
