...
impl<C, B> Bijection<C, B>
{
    ...
    pub fn values_view<'v>(&'v self) -> C::View<'v> where C: View { self.values.as_view() }
    pub fn values_view_mut<'v>(&'v mut self) -> C::ViewMut<'v> where C: ViewMut { self.values.as_mut_view() }
