...
impl<T> ToCoef for T where T : CastToComposite<CoefWrapper>
{
...
impl<T> FromCoef for T where T : DefaultRange + ToFloat<Output = float>, float : CastTo<T>
{
...
impl<T> ToFloat for T where T : CastToComposite<float>
{
    type Output=T::Output;
...
impl<T> ToF32 for T where T : CastToComposite<f32>
{
    type Output=T::Output;
...
impl<T> ToF64 for T where T : CastToComposite<f64>
{
    type Output=T::Output;
...
impl<T> ToInt for T where T : CastToComposite<int>
{
    type Output=T::Output;
...
impl<T> ToI8 for T where T : CastToComposite<i8>
{
    type Output=T::Output;
...
impl<T> ToI16 for T where T : CastToComposite<i16>
{
    type Output=T::Output;
...
impl<T> ToI32 for T where T : CastToComposite<i32>
{
    type Output=T::Output;
...
impl<T> ToI64 for T where T : CastToComposite<i64>
{
    type Output=T::Output;
...
impl<T> ToISize for T where T : CastToComposite<isize>
{
    type Output=T::Output;
...
impl<T> ToUInt for T where T : CastToComposite<uint>
{
    type Output=T::Output;
...
impl<T> ToU8 for T where T : CastToComposite<u8>
{
    type Output=T::Output;
...
impl<T> ToU16 for T where T : CastToComposite<u16>
{
    type Output=T::Output;
...
impl<T> ToU32 for T where T : CastToComposite<u32>
{
    type Output=T::Output;
...
impl<T> ToU64 for T where T : CastToComposite<u64>
{
    type Output=T::Output;
...
impl<T> ToUSize for T where T : CastToComposite<usize>
{
    type Output=T::Output;
