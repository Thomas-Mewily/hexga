...
impl<T, const N : usize> Vector<T,N> where T: Float
{
    ...
    pub fn vector_to_limited_by_length(self, target : Self, distance : T) -> Self where T: PartialOrd
    {
    ...
    pub fn move_to(&mut self, target : Self, distance : T) -> bool where T: PartialOrd, Self : AddAssign<Self>
    {
