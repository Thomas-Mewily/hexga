...
impl From<AppEvent> for AppMessage { fn from(value: AppEvent) -> Self { AppMessage::Event(value) } }
impl From<FlowMessage> for AppMessage { fn from(value: FlowMessage) -> Self { AppMessage::Flow(value) } }
