...
impl<A> MessageHandler<AppMessage> for AppMessageAdapter<A> where A:Application
{
...
impl<A> Application for AppMessageAdapter<A> where A:Application
{
...
#[derive(Debug)]
pub struct AppMessageAdapter<A> where A: Application
{
    pub app : A
}
impl<A> AppMessageAdapter<A> where A: Application
{
    pub fn new(app : A) -> Self { Self { app }}
}
impl<A> From<A> for AppMessageAdapter<A> where A: Application
{
