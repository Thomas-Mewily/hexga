...
#[derive(Debug, Copy, Clone, PartialEq, PartialOrd, Ord, Hash, Eq, Default)]
pub enum CursorIcon {
...
impl From<CursorIcon> for winit::window::CursorIcon
{
    fn from(value : CursorIcon) -> Self {
        match value
        {
            ...
            CursorIcon::DndAsk => winit::window::CursorIcon::DndAsk,
            CursorIcon::AllResize => winit::window::CursorIcon::AllResize,
        }
    }
}
