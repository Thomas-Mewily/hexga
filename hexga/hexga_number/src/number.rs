...
/// uX or iX
pub trait NumberInteger            : NumberPrimitive + Eq + Hash + Ord + BitManip + BitArithmetic + Increment + OverflowBehavior + fmt::Binary + fmt::Octal + fmt::LowerHex + fmt::UpperHex {}
impl<T> NumberInteger for T where T: NumberPrimitive + Eq + Hash + Ord + BitManip + BitArithmetic + Increment + OverflowBehavior + fmt::Binary + fmt::Octal + fmt::LowerHex + fmt::UpperHex {}
