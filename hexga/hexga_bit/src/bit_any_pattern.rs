...
/// [bytemuck::AnyBitPattern](https://docs.rs/bytemuck/latest/bytemuck/trait.AnyBitPattern.html) trait equivalent.
///
...
/// *immutable* references and *owned* values into [`BitAnyPattern`] types, not
/// *mutable* references.
///
...
/// # Derive
///
/// A `#[derive(BitAnyPattern)]` macro is provided under the `derive` feature
...
/// * Structs need to have all fields also be `BitAnyPattern`.
