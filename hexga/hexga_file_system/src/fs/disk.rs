...
type DiskWithAutoCorrect = FsAutoCorrectExtension<FsDiskNotAutoCorrected>;

#[derive(Debug, Default, Clone, Copy)]
pub struct FsDiskNotAutoCorrected;


impl FsRead for FsDiskNotAutoCorrected
{
...
impl FsWrite for FsDiskNotAutoCorrected
{
