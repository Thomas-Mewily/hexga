...
pub trait ToRon: Serialize
{
    ...
    {
        ron::ser::to_string_pretty(&self, ron::ser::PrettyConfig::default()).map_err(|e| EncodeError::markup::<Self>(Extension::RON, e))
    }
    #[allow(unused_mut)] // weird LSP error
    fn to_ron_with_writer<W: Write>(&self, mut writer: W) -> EncodeResult
    {
        ron::ser::to_writer_pretty(writer.to_fmt_writer(), &self, ron::ser::PrettyConfig::default()).map_err(|e| EncodeError::markup::<Self>(Extension::RON, e))
    }
}
...
pub trait ToJson: Serialize
{
    ...
    {
        serde_json::ser::to_writer_pretty(writer, &self).map_err(|e| EncodeError::markup::<Self>(Extension::JSON, e))
    }
}
...
pub trait FromJson: for<'de> Deserialize<'de>
{
    ...
    {
        serde_json::de::from_reader(reader).map_err(|e| EncodeError::markup::<Self>(Extension::JSON, e))
    }
...
pub trait ToXml: Serialize
{
    ...
    {
        serde_xml_rs::ser::to_writer(writer, &self).map_err(|e| EncodeError::markup::<Self>(Extension::XML, e))
    }
}
...
pub trait FromXml: for<'de> Deserialize<'de>
{
    ...
    {
        serde_xml_rs::de::from_reader(reader).map_err(|e| EncodeError::markup::<Self>(Extension::XML, e))
    }
...
pub trait ToTmpBin: Serialize
{
    ...
    {
        bincode::serialize_into(writer, self).map_err(|e| EncodeError::markup::<Self>(Extension::TMP_BIN, e))
    }
}
...
pub trait FromTmpBin: for<'de> Deserialize<'de>
{
    ...
    {
        bincode::deserialize_from(reader).map_err(|e| EncodeError::markup::<Self>(Extension::TMP_BIN, e))
    }
}
