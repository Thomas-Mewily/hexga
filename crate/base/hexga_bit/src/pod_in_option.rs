...
// Note(Mewily): Indeed this is cool!
/// [bytemuck::PodInOption](https://docs.rs/bytemuck/latest/bytemuck/trait.PodInOption.html) trait equivalent.
...
pub unsafe trait PodInOption: BitZeroInOption + Copy + 'static {}
