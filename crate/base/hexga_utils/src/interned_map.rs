...
{
    fn from(kv: Entry<K, V>) -> Self { (kv.key, kv.value) }
}
impl<K, V> Entry<K, V>
{
...
impl<K, V, C, S> PartialEq for InternedMap<K, V, C, S>
where
    K: Clone,
    K: PartialEq,
    V: PartialEq,
...
impl<K, V, C, S> Eq for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    K: Eq,
...
impl<K, V, C, S> Hash for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    K: Hash,
...
#[cfg(feature = "serde")]
impl<K, V, Gen, St> Serialize for InternedMap<K, V, Gen, St>
where
    K: Clone,
    Gen: IGeneration,
    K: Serialize,
...
#[cfg(feature = "serde")]
impl<'de, K, V, Gen, St> Deserialize<'de> for InternedMap<K, V, Gen, St>
where
    K: Clone,
    Gen: IGeneration,
    K: Deserialize<'de>,
...
impl<K, V, C, S> AsRef<GenSeq<Entry<K, V>, Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
{
    fn as_ref(&self) -> &GenSeq<Entry<K, V>, Gen> { &self.values }
}
impl<K, V, C, S> Default for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Default,
...
impl<K, V, C, S> Debug for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    K: Debug,
...
impl<K, V, C, S> Collection for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<K, V, C, S> CollectionBijective for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<K, V, C, S> InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
{
        ...
        S: Insert<K, GenIDOf<V, Gen>>,
    {
        ...
        match old_id
        {
            ...
            None =>
            {
                let id = self
                    .values
                    .insert_cyclic(|id| Entry::new(key.clone(), init(id.typed())));
                let id = id.typed::<V>();
                self.search.insert(key, id);
                (id, None)
            }
    ...
    */
    ...
    pub fn values(&self) -> impl Iterator<Item = &V> + '_ { self.into_iter().map(|(_id, _k, v)| v) }
...
impl<K, V, C, S> WithCapacity for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
...
impl<K, V, C, S> Capacity for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Capacity,
...
impl<K, V, C, S> Reserve for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Reserve + Length,
...
impl<K, V, C, S> Shrink for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Shrink,
...
impl<K, V, C, S> Length for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<'a, Q, K, V, Gen, S> Get<&'a Q> for InternedMap<K, V, C, S>
where
    Q: ?Sized,
    K: Clone + Borrow<Q>,
    Gen: IGeneration,
...
impl<'a, Q, K, V, Gen, S> Index<&'a Q> for InternedMap<K, V, C, S>
where
    Q: ?Sized,
    K: Clone + Borrow<Q>,
    Gen: IGeneration,
    S: Get<&'a Q, Output = GenIDOf<V, Gen>>,
{
    ...
    {
        <Self as Get<&'a Q>>::get_or_panic(self, index)
    }
}

impl<'a, Q, K, V, Gen, S> TryGet<&'a Q> for InternedMap<K, V, C, S>
where
    Q: ?Sized + Clone,
    K: Clone + Borrow<Q>,
    Gen: IGeneration,
...
impl<K, V, C, S> Get<UntypedGenIDOf<Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<K, V, C, S> Get<GenIDOf<V, Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<K, V, C, S> Index<GenIDOf<V, Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<K, V, C, S> Index<UntypedGenIDOf<Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<K, V, C, S> TryGet<GenIDOf<V, Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<K, V, C, S> TryGet<UntypedGenIDOf<Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<'a, Q, K, V, Gen, S> GetMut<&'a Q> for InternedMap<K, V, C, S>
where
    Q: ?Sized,
    K: Clone + Borrow<Q>,
    Gen: IGeneration,
...
impl<'a, Q, K, V, Gen, S> IndexMut<&'a Q> for InternedMap<K, V, C, S>
where
    Q: ?Sized,
    K: Clone + Borrow<Q>,
    Gen: IGeneration,
...
impl<'a, Q, K, V, Gen, S> TryGetMut<&'a Q> for InternedMap<K, V, C, S>
where
    Q: ?Sized + Clone,
    K: Clone + Borrow<Q>,
    Gen: IGeneration,
...
impl<K, V, C, S> GetMut<GenIDOf<V, Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<K, V, C, S> GetMut<UntypedGenIDOf<Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<K, V, C, S> IndexMut<GenIDOf<V, Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<K, V, C, S> IndexMut<UntypedGenIDOf<Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<K, V, C, S> TryGetMut<GenIDOf<V, Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<K, V, C, S> TryGetMut<UntypedGenIDOf<Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
{
    #[inline(always)]
    fn try_get_mut(&mut self, index: UntypedGenIDOf<Gen>)
...
impl<K, V, C, S> GetManyMut<GenIDOf<V, Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<K, V, C, S> GetManyMut<UntypedGenIDOf<Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Collection,
...
impl<K, V, C, S> Insert<K, V> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Insert<K, GenIDOf<V, Gen>>,
...
/*
impl<K, V, C, S> Insert<K, V> for GenMapOf<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
...
impl<'a, Q, K, V, Gen, S> Remove<&'a Q> for InternedMap<K, V, C, S>
where
    Q: ?Sized,
    K: Clone + Borrow<Q>,
    Gen: IGeneration,
...
impl<K, V, C, S> Remove<GenIDOf<V, Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
...
impl<K, V, C, S> Remove<UntypedGenIDOf<Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: for<'a> Remove<&'a K, Output = GenIDOf<V, Gen>>,
...
impl<K, V, C, S> FromIterator<(K, V)> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
...
impl<K, V, C, S> From<GenSeq<Entry<K, V>, Gen>> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Default + Insert<K, GenIDOf<V, Gen>>,
...
impl<K, V, C, S> Extend<(K, V)> for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
    S: Insert<K, GenIDOf<V, Gen>>,
...
where
    Gen: IGeneration,
{
    iter: crate::gen_seq::IntoIter<
        Entry<K, V>,
        std::vec::IntoIter<crate::gen_seq::Entry<Entry<K, V>, Gen>>,
        Gen,
    >,
}
...
impl<K, V, C, S> IntoIterator for InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
{
...
impl<'a, K, V, Gen, S> IntoIterator for &'a InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
{
...
impl<'a, K, V, Gen, S> IntoIterator for &'a mut InternedMap<K, V, C, S>
where
    K: Clone,
    Gen: IGeneration,
{
...
where
    K: Clone,
{
    fn to_genmap(self) -> InternedMap<K, V, Generation, S>
    where
        InternedMap<K, V, Generation, S>: WithCapacity + Reserve,
        <InternedMap<K, V, Generation, S> as WithCapacity>::Param: Default,
