...
impl WithEventLoopShortcut for AppParam
{
    ...
    fn paste_shortcut(&self) -> Option<KeyShortcut> {
        self.event_loop.paste_shortcut()
    }
...
impl WindowAttribute for AppParam
{
    ...
    fn level(&self) -> hexga_event_loop::window::WindowLevel {
        self.window.level()
    }
    ...
    fn buttons(&mut self) -> hexga_event_loop::window::WindowButtonFlags {
        self.window.buttons()
    }
